...
<script type="text/javascript">
    var toolbar = [{
        ...
        handler: function () {
            ...
            if(row == null ){
                ...
                if(row.size == null){  //选中的是专辑
                    ...
                    $("#coverImg").prop("src",'${pageContext.request.contextPath}/back/easyui/album/'+row.coverImg);
        ...
        handler: function () {
            var row = $("#album").treegrid("getSelected");
            location.href = "${pageContext.request.contextPath}/chapter/down?fileName=" + row.downLoadPath + "&openStyle=attachment";
        }
    }]
            ...
            onDblClickRow:function (row){
                ...
                if (row == null) {
                    ...
                    if (row.downLoadPath != null) {
                        ...
                        $("#audio").prop("src", '${pageContext.request.contextPath}/back/easyui/music/'+row.downLoadPath)
...
<div id="album_dialog" class="easyui-dialog" title="专辑详情" style="width:400px;height:600px;"
    ...
    <form id="album_ff" method="post">
        ...
        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="score" name="score" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%" value="★★★★★">
        </div>
        ...
        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="broadCast" name="broadCat" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%">
        </div>
        ...
        <div style="height: 20px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <input id="status" name="status" type="text"  class="easyui-validatebox"  style="width:100%;height: 100%" value="y">
        </div>
...
<%--双击播放--%>
<div id="album_paly" class="easyui-dialog" title="播放音频" style="width:400px;height:200px;text-align: center;"
...
<div id="album_addg" class="easyui-dialog" title="添加专辑" style="width:400px;height:650px;"
    ...
    <form id="album_add" method="post" enctype="multipart/form-data">
        ...
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="broadCat" required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'播音员'" style="width:100%;height: 100%">
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
        ...
        <div style="height: 40px;margin-bottom: 30px;margin-top: 10px;padding-left: 20%;padding-right: 20%">
            <input name="file" required="true"  class="easyui-filebox"  style="width:100%;height: 100%" prompt="专辑图片">
        </div>
    </form>
