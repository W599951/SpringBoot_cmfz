...
public class ChapterController {
    ...
    public void download(String fileName, String openStyle, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String realPath = request.getSession().getServletContext().getRealPath("/back/easyui/music");
    ...
    public String save(MultipartFile file, HttpServletRequest request, Chapter chapter) throws IOException {
        String realPath = request.getSession().getServletContext().getRealPath("/back/easyui/music");//获取文件绝对路径
        ...
        chapter.setDownLoadPath(file.getOriginalFilename());//设置下载路径
