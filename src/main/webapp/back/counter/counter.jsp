    ...
    $(function () {
        $("#counter").datagrid({
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        if (rows.length < 0) {
                            ...
                            $.ajax({
                                url: '${pageContext.request.contextPath}/counter/delBatchRows',
                                type: 'POST',
            ...
            columns: [[
                ...
                {title: '数值', field: 'count', width: 120,},
                {title: '用户ID', field: 'user_id', width: 120,},
                {title: '课程ID', field: 'course_id', width: 120,},
    ...
    function delRow(id){
        $.messager.confirm("确认对话框","确定删除么？？",function(b){
            if(b){
                ...
                $.post("${pageContext.request.contextPath}/counter/delete",{"id":id},function (result) {//响应成功之后回调
                    //刷新datagrid数据
...
<%--添加对话框--%>
<div id="countersaveDialog"
     data-options="href:'${pageContext.request.contextPath}/back/counter/countersave.jsp',draggable:false,iconCls:'icon-save',width:600,height:400,title:'添加'"></div>

    <%--修改对话框--%>
    <div id="countereditDialog" data-options="draggable:false,iconCls:'icon-edit',width:600,height:400,title:'修改信息'">
    </div>
